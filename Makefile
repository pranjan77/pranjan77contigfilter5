SERVICE = pranjan77contigfilter5
SERVICE_CAPS = pranjan77Contigfilter5
SPEC_FILE = pranjan77Contigfilter5.spec
URL = https://kbase.us/services/pranjan77contigfilter5
DIR = $(shell pwd)
LIB_DIR = lib
SCRIPTS_DIR = scripts
TEST_DIR = test
