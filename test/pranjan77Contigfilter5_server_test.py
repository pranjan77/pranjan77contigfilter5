...
from pranjan77Contigfilter5.pranjan77Contigfilter5Impl import pranjan77Contigfilter5


class pranjan77Contigfilter5Test(unittest.TestCase):

    @classmethod
    def setUpClass(cls):
        token = environ.get('KB_AUTH_TOKEN', None)
        cls.ctx = {'token': token, 'provenance': [{'service': 'pranjan77Contigfilter5',
        ...
        for nameval in config.items('pranjan77Contigfilter5'):
            cls.cfg[nameval[0]] = nameval[1]
        cls.wsURL = cls.cfg['workspace-url']
        cls.wsClient = workspaceService(cls.wsURL, token=token)
        cls.serviceImpl = pranjan77Contigfilter5(cls.cfg)
    ...
    def getWsName(self):
        ...
        wsName = "test_pranjan77Contigfilter5_" + str(suffix)
